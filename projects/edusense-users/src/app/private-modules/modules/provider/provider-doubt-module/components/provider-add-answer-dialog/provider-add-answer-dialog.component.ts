...
@Component({
  selector: 'es-user-provider-add-answer-dialog',
  templateUrl: './provider-add-answer-dialog.component.html',
  styleUrls: ['./provider-add-answer-dialog.component.scss']
})
export class ProviderAddAnswerDialogComponent extends FormBaseComponent implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ProviderAddAnswerDialogComponent>,
