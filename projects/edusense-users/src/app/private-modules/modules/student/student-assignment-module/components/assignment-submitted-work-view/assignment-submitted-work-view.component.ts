...
@Component({
    selector: 'es-user-assignment-submitted-work-view',
    templateUrl: './assignment-submitted-work-view.component.html',
    styleUrls: ['./assignment-submitted-work-view.component.scss']
})
export class AssignmentSubmittedWorkViewComponent implements OnInit {
    // Angular variables
    @Input() submissionDetail: SubmittedAssignmentModel;
        ...
        if (this.videoType.find(e => e == fileType)) {
            const dialogRef = this.dialog.open(ViewMaterialDialogComponent, {
                ...
                data: {
                    ...
                    fileData,
                    showSlider: true,
                    totalNumber: this.submissionDetail
            ...
            dialogRef.afterClosed().subscribe(result => {
                if (result) {
                    let assignment = this.submissionDetail
