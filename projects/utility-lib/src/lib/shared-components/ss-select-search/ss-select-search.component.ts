...
export class SelectSearchComponent extends FormBaseComponent
    ...
    createSearchForm() {
        this.formName.registerControl(this.selectConfig?.filterControlName, new FormControl(''));
        this.filteredData.next(this.dataList.slice());

        // listen for search field value changes
        this.formName.controls[this.selectConfig?.filterControlName].valueChanges
    ...
    filterData() {
        ...
        let search = this.formName.controls[this.selectConfig?.filterControlName].value;
        if (!search) {
            this.filteredData.next(this.dataList.slice());
            return;
        } else {
